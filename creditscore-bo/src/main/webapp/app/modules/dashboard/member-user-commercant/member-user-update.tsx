...
const MemberUserUpdate = () => {
  ...
  const columnsInvoice: TableColumnsType = [
    ...
    { title: 'Montant', dataIndex: 'amount', key: 'amount',render: (text) => text && `${text?.replace(/\B(?=(\d{3})+(?!\d))/g, " ")} TND`,  },
  ...
  useEffect(() => {
    if (updateSuccess) {
      navigate('/dashboard/member-user-commercant');
    }
  }, [updateSuccess]);
  ...
  useEffect(() => {
    isNew
      ...
      : form.setFieldsValue({
        ...memberUserEntity,
        birthDate: memberUserEntity.birthDate ? dayjs(memberUserEntity.birthDate) : null,
      });
  }, [memberUserEntity]);
          ...
          <Row>
            <Col span={11}>
              ...
              <Form.Item
                ...
                rules={[{ required: true, message: 'Veuillez renseigner ce champ !' }]}
              >
                <Select placeholder={CustomPlaceholderRole} style={{ width: '100%' }} defaultValue="customer" disabled>
                  {roleValues.map(role => (
              ...
              >
                ...
                <Select style={{ width: 562 }}>
                  {/*<Select.Option value={"cin"} key={"cin"}>
                    Cin
                  </Select.Option>
                  <Select.Option value={"passport"} key={"passport"}>
                    Passeport
                  </Select.Option>

                  <Select.Option value={"tax_registration"} key={"tax_registration"}>
              ...
              >
                <Input
                  ...
                  placeholder="fonction sociale"
                />
              </Form.Item>
            </Col>
            <Divider type="vertical" style={{ height: 740 }} />
            <Col span={11} style={{ marginLeft: 10 }}>
              ...
              <Form.Item
                ...
                rules={[{ required: true, message: 'Veuillez renseigner ce champ !' }]}
              >
                <Select placeholder={CustomPlaceholderTypeAccount} style={{ width: 562 }}>
                    <Select.Option value={"PHYSICAL_PERSON"} key={"PHYSICAL_PERSON"}>
                      Personne physique
                    </Select.Option>
                  <Select.Option value={"CORPORATION"} key={"CORPORATION"}>
                    Société
                  </Select.Option>
      ...
      <Row justify="space-between" style={{ marginBottom: 15 }}>
        ...
        <Col>
          <div style={{ display: 'flex', flexDirection: 'row' }}>
            <Link to="/dashboard/member-user-commercant">
              <Button
                className="me-2"

            ...
            <tbody>
              {contactList.map((contact, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{contact.memberUser ? <Link to={`/member-user/${contact.memberUser.id}`}>{contact.memberUser.id}</Link> : ''}</td>
                  <td>{contact.banks ? <Link to={`/banks/${contact.banks.id}`}>{contact.banks.id}</Link> : ''}</td>
                  <td>{contact.agencies ? <Link to={`/agencies/${contact.agencies.id}`}>{contact.agencies.id}</Link> : ''}</td>

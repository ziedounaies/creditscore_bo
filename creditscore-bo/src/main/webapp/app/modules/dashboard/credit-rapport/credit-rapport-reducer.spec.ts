...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CREDITRAPPORT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CREDITRAPPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CREDITRAPPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CREDITRAPPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CREDITRAPPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CREDITRAPPORT actions', async () => {
      const expectedActions = [
        {

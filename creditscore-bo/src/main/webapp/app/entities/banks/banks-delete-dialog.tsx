...
export const BanksDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/banks' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="creditScoreApp.banks.delete.question">Êtes-vous certain de vouloir supprimer le Banks {banksEntity.id} ?</ModalBody>
      <ModalFooter>

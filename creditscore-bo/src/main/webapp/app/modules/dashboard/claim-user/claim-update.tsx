...
const ClaimUpdate = () => {
  ...
  const handleClose = () => {
    navigate('/dashboard/claim-user' + location.search);
  };
  ...
  return (
    <div>
      <Card style={{ borderRadius: 10, width: '100%' ,height:690}}>
        ...
        <Row>
          <Col span={11}>
            <Form layout="vertical" name="claimForm" onFinish={onFinish} initialValues={defaultValues()}>
              ...
              {/*  >*/}
              {/*    <Select.Option value="PENDING">en_attente</Select.Option>*/}
              {/*    <Select.Option value="IN_PROGRESS, ">en_cours</Select.Option>*/}

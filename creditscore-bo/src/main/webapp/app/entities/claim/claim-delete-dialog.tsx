...
export const ClaimDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/claim' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="creditScoreApp.claim.delete.question">Êtes-vous certain de vouloir supprimer le Claim {claimEntity.id} ?</ModalBody>
      <ModalFooter>

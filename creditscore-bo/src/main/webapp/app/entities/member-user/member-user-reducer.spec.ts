...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEMBERUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEMBERUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEMBERUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEMBERUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEMBERUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEMBERUSER actions', async () => {
      const expectedActions = [
        {

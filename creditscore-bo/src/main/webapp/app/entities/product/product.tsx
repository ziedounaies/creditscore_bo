          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('guarantee')}>
                  Guarantee <FontAwesomeIcon icon={getSortIconByFieldName('guarantee')} />
                </th>
            ...
            <tbody>
              {productList.map((product, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{product.invoice ? <Link to={`/invoice/${product.invoice.id}`}>{product.invoice.id}</Link> : ''}</td>

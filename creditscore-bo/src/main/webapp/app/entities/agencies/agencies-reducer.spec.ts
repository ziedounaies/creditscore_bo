...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './agencies.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENCIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_AGENCIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AGENCIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AGENCIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AGENCIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AGENCIES actions', async () => {
      const expectedActions = [
        {
